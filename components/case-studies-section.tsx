...
const caseStudies = [
  {
    ...
    description: "Complete character pipeline for a AAA fantasy role-playing game",
  ...
  },
  {
    ...
    description: "Complete UI/UX redesign that increased player retention by 45%",
  ...
  },
  {
    ...
    description: "Innovative environment generation system for an open-world adventure",
